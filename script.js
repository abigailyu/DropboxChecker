...
const filenames=["/Backup/sql/ecs_cloud_mysql.sql.gz.gpg", "/Backup/apps/deployment.tar.bz2", "/Backup/apps/pressgang-ccms-ui.war", "/Backup/code/PressGangCCMSUI.tar.bz2"];
var tableHTML = "";
